namespace iControl {
 ...
 out long file_offset) {
	...
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:ASM/Policy", 
		RequestNamespace="urn:iControl:ASM/Policy", ResponseNamespace="urn:iControl:ASM/Policy")]
	[return: System.Xml.Serialization.SoapElementAttribute("return")]
	public bool [] is_complex_assoc(
		string [] policy_names
	) {
		object [] results = this.Invoke("is_complex_assoc", new object [] {
				policy_names});
		return ((bool [])(results[0]));
	}
	public System.IAsyncResult Beginis_complex_assoc(string [] policy_names, System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("is_complex_assoc", new object[] {
			policy_names}, callback, asyncState);
	}
	public bool [] Endis_complex_assoc(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
		return ((bool [])(results[0]));
	}
