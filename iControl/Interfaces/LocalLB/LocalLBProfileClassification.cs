namespace iControl {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="LocalLB.ProfileClassificationBinding", Namespace="urn:iControl")]
	public partial class LocalLBProfileClassification : iControlInterface {
		public LocalLBProfileClassification() {
	...
	// get_default_profile
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:LocalLB/ProfileClassification", 
		RequestNamespace="urn:iControl:LocalLB/ProfileClassification", ResponseNamespace="urn:iControl:LocalLB/ProfileClassification")]
