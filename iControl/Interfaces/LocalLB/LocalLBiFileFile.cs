namespace iControl {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="LocalLB.iFileFileBinding", Namespace="urn:iControl")]
	...
	public partial class LocalLBiFileFile : iControlInterface {
		public LocalLBiFileFile() {
	...
	// create
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:LocalLB/iFileFile", 
		RequestNamespace="urn:iControl:LocalLB/iFileFile", ResponseNamespace="urn:iControl:LocalLB/iFileFile")]
	public void create(
		string [] files,
		string [] paths
	) {
	...
	//-----------------------------------------------------------------------
	// delete_all_ifile_files
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:LocalLB/iFileFile", 
		RequestNamespace="urn:iControl:LocalLB/iFileFile", ResponseNamespace="urn:iControl:LocalLB/iFileFile")]
	public void delete_all_ifile_files(

	) {
		this.Invoke("delete_all_ifile_files", new object [0]);

	}
	public System.IAsyncResult Begindelete_all_ifile_files(System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("delete_all_ifile_files", new object[0], callback, asyncState);
	}
	public void Enddelete_all_ifile_files(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}
	...
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:LocalLB/iFileFile", 
		RequestNamespace="urn:iControl:LocalLB/iFileFile", ResponseNamespace="urn:iControl:LocalLB/iFileFile")]
	public void delete_ifile_file(
		string [] files
	) {
		this.Invoke("delete_ifile_file", new object [] {
				files});

	}
	public System.IAsyncResult Begindelete_ifile_file(string [] files, System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("delete_ifile_file", new object[] {
			files}, callback, asyncState);
	}
	public void Enddelete_ifile_file(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}
