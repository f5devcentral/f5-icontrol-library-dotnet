namespace iControl {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="Log.DestinationSplunkBinding", Namespace="urn:iControl")]
	public partial class LogDestinationSplunk : iControlInterface {
		public LogDestinationSplunk() {
	...
	// create
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Log/DestinationSplunk", 
		RequestNamespace="urn:iControl:Log/DestinationSplunk", ResponseNamespace="urn:iControl:Log/DestinationSplunk")]
	public void create(
		string [] destinations,
	...
	//-----------------------------------------------------------------------
	// delete_all_splunk_destinations
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Log/DestinationSplunk", 
		RequestNamespace="urn:iControl:Log/DestinationSplunk", ResponseNamespace="urn:iControl:Log/DestinationSplunk")]
	public void delete_all_splunk_destinations(

	) {
		this.Invoke("delete_all_splunk_destinations", new object [0]);

	}
	public System.IAsyncResult Begindelete_all_splunk_destinations(System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("delete_all_splunk_destinations", new object[0], callback, asyncState);
	}
	public void Enddelete_all_splunk_destinations(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}

	//-----------------------------------------------------------------------
	// delete_splunk_destination
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Log/DestinationSplunk", 
		RequestNamespace="urn:iControl:Log/DestinationSplunk", ResponseNamespace="urn:iControl:Log/DestinationSplunk")]
	public void delete_splunk_destination(
		string [] destinations
	) {
		this.Invoke("delete_splunk_destination", new object [] {
				destinations});

	}
	public System.IAsyncResult Begindelete_splunk_destination(string [] destinations, System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("delete_splunk_destination", new object[] {
			destinations}, callback, asyncState);
	}
	public void Enddelete_splunk_destination(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}
