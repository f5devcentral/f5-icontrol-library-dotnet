namespace iControl {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="Management.ApplicationPresentationScriptBinding", Namespace="urn:iControl")]
	public partial class ManagementApplicationPresentationScript : iControlInterface {
		public ManagementApplicationPresentationScript() {
	...
	// add_checksum
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Management/ApplicationPresentationScript", 
		RequestNamespace="urn:iControl:Management/ApplicationPresentationScript", ResponseNamespace="urn:iControl:Management/ApplicationPresentationScript")]
	...
	//-----------------------------------------------------------------------
	// delete_all_application_presentation_scripts
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Management/ApplicationPresentationScript", 
		RequestNamespace="urn:iControl:Management/ApplicationPresentationScript", ResponseNamespace="urn:iControl:Management/ApplicationPresentationScript")]
	public void delete_all_application_presentation_scripts(

	) {
		this.Invoke("delete_all_application_presentation_scripts", new object [0]);

	}
	public System.IAsyncResult Begindelete_all_application_presentation_scripts(System.AsyncCallback callback, object asyncState) {
		return this.BeginInvoke("delete_all_application_presentation_scripts", new object[0], callback, asyncState);
	}
	public void Enddelete_all_application_presentation_scripts(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}

	//-----------------------------------------------------------------------
	// delete_application_presentation_script
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Management/ApplicationPresentationScript", 
		RequestNamespace="urn:iControl:Management/ApplicationPresentationScript", ResponseNamespace="urn:iControl:Management/ApplicationPresentationScript")]
	public void delete_application_presentation_script(
		string [] scripts
	) {
		this.Invoke("delete_application_presentation_script", new object [] {
				scripts});
	...
	public void Enddelete_application_presentation_script(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
	}
