namespace iControl {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name="Networking.ProfileGeneveBinding", Namespace="urn:iControl")]
	[System.Xml.Serialization.SoapIncludeAttribute(typeof(NetworkingProfileGeneveProfileGeneveFloodingType))]
	[System.Xml.Serialization.SoapIncludeAttribute(typeof(CommonProfilePortNumber))]
	public partial class NetworkingProfileGeneve : iControlInterface {
		public NetworkingProfileGeneve() {
	...
	// create
	//-----------------------------------------------------------------------
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Networking/ProfileGeneve", 
		RequestNamespace="urn:iControl:Networking/ProfileGeneve", ResponseNamespace="urn:iControl:Networking/ProfileGeneve")]
	public void create(
	...
	[System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:iControl:Networking/ProfileGeneve", 
		RequestNamespace="urn:iControl:Networking/ProfileGeneve", ResponseNamespace="urn:iControl:Networking/ProfileGeneve")]
	[return: System.Xml.Serialization.SoapElementAttribute("return")]
	public NetworkingProfileGeneveProfileGeneveFloodingType [] get_flooding_type(
		string [] profile_names
	) {
		object [] results = this.Invoke("get_flooding_type", new object [] {
				profile_names});
		return ((NetworkingProfileGeneveProfileGeneveFloodingType [])(results[0]));
	}
	...
	public NetworkingProfileGeneveProfileGeneveFloodingType [] Endget_flooding_type(System.IAsyncResult asyncResult) {
		object [] results = this.EndInvoke(asyncResult);
		return ((NetworkingProfileGeneveProfileGeneveFloodingType [])(results[0]));
	}
	...
	[System.Xml.Serialization.SoapTypeAttribute(TypeName = "Networking.ProfileGeneve.GeneveFloodingType", Namespace = "urn:iControl")]
	public enum NetworkingProfileGeneveGeneveFloodingType
	{
		PROFILE_GENEVE_FLOODING_TYPE_UNKNOWN,
		PROFILE_GENEVE_FLOODING_TYPE_NONE,
		PROFILE_GENEVE_FLOODING_TYPE_MULTICAST,
		PROFILE_GENEVE_FLOODING_TYPE_MULTIPOINT,
	}
	...
	[System.Diagnostics.DebuggerStepThroughAttribute()]
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.SoapTypeAttribute(TypeName = "Networking.ProfileGeneve.ProfileGeneveFloodingType", Namespace = "urn:iControl")]
	public partial class NetworkingProfileGeneveProfileGeneveFloodingType
	{
		private NetworkingProfileGeneveGeneveFloodingType valueField;
		public NetworkingProfileGeneveGeneveFloodingType value
		{
